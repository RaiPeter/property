const { createProperty, getProperties, getAllProperties, getAvailableProperties, getSoldProperties, getIncomeFromSoldProperties } = require("../db/property-db");
...
const getPropertiesStatsService = async () =>{
  try{
    ...
    return { totalProperties, availableProperties, soldProperties, totalIncome, lastMonthProperties}
  }catch(e){
